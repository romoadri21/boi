...
void DescriptionManager::InitStandardDescriptions()
{
    ...
    pDescription->SetTitle("Set Position");
    ...
    pDescription->SetTitle("Set Rotation");
    ...
    pDescription->SetTitle("Set Opacity");
    ...
    pDescription->SetTitle("Set Visible");
    ...
    pDescription->SetTitle("Parent Bounding Box");
    ...
    pDescription->SetTitle("Load Url");
    ...
    pDescription->SetTitle("Set HTML");
    ...
    pDescription->SetTitle("Evaluate Javascript");
    ...
    pDescription->SetTitle("Default Browser Emitter");
    ...
    pDescription->SetTitle("Set Text");
    ...
    pDescription->SetTitle("Append Text");
    ...
    pDescription->SetTitle("Insert Text");
    ...
    pDescription->SetTitle("Start Timer");
    ...
    pDescription->SetTitle("Stop Timer");
    ...
    pDescription->SetTitle("Window Size");
    ...
    pDescription->SetTitle("Window Width");
    ...
    pDescription->SetTitle("Window Height");
    ...
    pDescription->SetTitle("Javascript Emitter 1");
    ...
    pDescription->SetTitle("Javascript Emitter 2");
    ...
    pDescription->SetTitle("Javascript Emitter 3");
    ...
    pDescription->SetTitle("Javascript Emitter 4");
    ...
    pDescription->SetTitle("Javascript Receiver Func 1");
    ...
    pDescription->SetTitle("Javascript Receiver Func 2");
    ...
    pDescription->SetTitle("Javascript Receiver Func 3");
    ...
    pDescription->SetTitle("Javascript Receiver Func 4");
    ...
    pDescription->SetTitle("Set Font Size");
