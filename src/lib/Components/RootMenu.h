...
#ifndef __BOI_ROOTMENU_H
#define __BOI_ROOTMENU_H
...
#define BOI_ROOT_MENU_NUM_FILLS 4
...
class RootMenu
{
    ...
    private:
        ...
        QBrush m_fills[BOI_ROOT_MENU_NUM_FILLS];
