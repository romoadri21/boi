...
#ifndef __BOI_CONTEXTMENU_H
#define __BOI_CONTEXTMENU_H
...
#define BOI_CONTEXT_MENU_NUM_FILLS 4
...
class ContextMenu
{
    public:
        ...
        void SetOrientation(bool leftOriented);
    ...
    private:
        ...
        QBrush m_fills[BOI_CONTEXT_MENU_NUM_FILLS];
